...
using Scaffold_Bike_stores_Database.Models;

namespace Scaffold_Bike_stores_Database.Data;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E277C4FC093");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B477898E88");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8530C8B459");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229720D7B7B");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4BBDCBFD6");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5ED99C9C1");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C06167447");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61641DC325EF").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D349624364");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C50A770DF");
